...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 0, 166, 1));
		...
		//background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 800, 276, -4));
		...
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 570, 329, 1));
